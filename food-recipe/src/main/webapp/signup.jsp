    ...
    <script type="text/javascript">
        ...
        async function ajaxEmailCheck() {
              return new Promise((resolve, reject) => {
                  ...
                  request.open("GET", "http://localhost:6969/food-recipe/rest/validateEmail/" + encodedEmail);
                  request.send();
        ...
        async function validateForm(event) {
           ...
           if (await validateFirstName()   && await validateLastName() &&
               await validatePhoneNumber() && await validateAPhoneNumber() &&
               await validateFoodType()    && await validateAddress() &&
               await validateEmail()       && await validatePassword()) {
                   document.getElementById('register').disabled = false;
                   event.target.submit();
...
<body>
  ...
  <form  onsubmit="validateForm(event)" method="post" action="register" >
    <div><h2>Register with food recipies</h2></div>
        <div class="fields">
        <label for="firstName">First Name:</label>
        <input placeholder="first name" type="text" id="firstName" name="firstName" onblur="validateFirstName()">
        </div>
        <div id="firstNameError" class="error">Enter valid Fiirst Name</div>

        <div class="fields">
        <label for="lastName">Last Name:</label>
        <input placeholder="last name" type="text" id="lastName" name="lastName" onblur="validateLastName()">
        </div>
        <div id="lastNameError" class="error">Enter valid Last Name</div>

        <div class="fields">
        <label for="contact">Contact No:</label>
        <input placeholder="contact number" type="text" id="contact" name="phone" onblur="validatePhoneNumber()">
        </div>
        ...
        <input placeholder="alternate number" type="text" id="acontact" name="alternatePhone" onblur="validateAPhoneNumber()">
        </div>
        ...
        <textarea placeholder="address" type="text" id="address" name="address" onblur="validateAddress()"></textarea>
        </div>
        ...
        <div><button  id="register" type="submit" disabled >Register</button></div>
        <div><h4>Already a user? click <a href="login.jsp">here</a> to login</h4></div>
  </form>
  <footer>
      <a href="">Facebook</a>
      <a href="">Twitter</a>
